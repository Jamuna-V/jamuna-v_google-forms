...
public class ImdbRatings {
    ...
    public void testCase01() {
        ...
        // Navigate to "https://www.imdb.com/chart/top/"
        // driver.get("https://www.imdb.com/chart/top/")
        driver.get("https://www.imdb.com/chart/top/");

        // Find the highest rated movie Using Locator "XPath" //div[@data-testid =
        // 'chart-layout-main-column']/ul/li[1]//h3
        ...
        // Find the total movies on the table Using Locator "XPath" //div[@data-testid =
        // 'chart-layout-main-column']/ul/li
        ...
        // Select the "Release date" from dropdown Select sort = new Select(<Sort by
        // WebElement>) | selectByVisibleText("Release date")
        Select sort = new Select(sortBy);
        sort.selectByVisibleText("Release date");

        // Click on the Swap button next to Sort by dropdown to get the oldest movie on
        // the top of the table Using Locator "ID" swap-sort-order-button
        driver.findElement(By.id("swap-sort-order-button")).click();

        // Wait for the sorting to happen
        // wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@data-testid
        // = 'chart-layout-main-column']/ul/li[1]//h3")));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        wait.until(ExpectedConditions
                .presenceOfElementLocated(By.xpath("//div[@data-testid = 'chart-layout-main-column']/ul/li[1]//h3")));

        // Find the oldest movie Using Locator "XPath" //div[@data-testid =
        // 'chart-layout-main-column']/ul/li[1]//h3
        ...
        // Find the recent movie Using Locator "XPath" //div[@data-testid =
        // 'chart-layout-main-column']/ul/li["+count+"]//h3
        ...
        // Select the "Number of ratings" from dropdown selectByVisibleText("Number of
        // ratings")
        ...
        // = 'chart-layout-main-column']/ul/li[1]//h3")));
        wait.until(ExpectedConditions
                .visibilityOfElementLocated(By.xpath("//div[@data-testid = 'chart-layout-main-column']/ul/li[1]//h3")));

        // Find the movie with the most user ratings which is listed on the top of the
        // table Using Locator "XPath" //div[@data-testid =
        // 'chart-layout-main-column']/ul/li[1]//h3
