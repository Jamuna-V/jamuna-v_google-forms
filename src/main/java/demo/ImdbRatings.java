...
public class ImdbRatings {
    ...
    public void testCase01() {
       ...
       //Find the total movies on the table
        ...
        //Select the "Release date" from dropdown
        Select sort = new Select(sortBy);
        sort.selectByVisibleText("Release date");

        //Click on the Swap button next to Sort by dropdown to get the oldest movie on the top of the table
