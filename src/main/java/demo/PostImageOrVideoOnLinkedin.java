...
public class PostImageOrVideoOnLinkedin {
    ...
    public void testCase01() throws InterruptedException {
        ...
        // Click the Add Media button Using Locator "XPath" //button[@class =
        // 'share-promoted-detour-button' and @aria-label = 'Add media' ]
        driver.findElement(By.xpath("//button[@class = 'share-promoted-detour-button' and @aria-label = 'Add media' ]"))
                .click();

        // Upload the picture Using Locator "XPath" //input[@type='file'] |
        // sendKeys("<file path>")
        ...
        // Verfiy if the image has been posted in timeline successfully Using Locator
        // "XPath" //img[@alt='Image preview'] |isDisplayed()
