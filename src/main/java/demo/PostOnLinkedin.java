...
public class PostOnLinkedin {
    ...
    public void testCase01() {
        ...
        //Verify if Connections and its count is visible Using Locator "XPath" //span[text() = 'Connections']/../../following-sibling::div//strong
        ...
        //Verify if Who's viewed your profile and its count is visible  //span[text() = \"Who's viewed your profile\"]/../../following-sibling::div//strong
        ...
        //Click inside "What do you want to talk about?" Using Locator "XPath" //div[@data-placeholder = 'What do you want to talk about?']
        ...
        //Verify if the post has appeared on the timeline  //span[contains(text(),'Good Afternoon')] | isDisplayed()
